...
- `rate_card:configure`
- `worm:export`
- `cyrano:policy:write` _(new — added by `CYRANO-ACCESS-POLICY-001`)_
- `pixel_legacy:seat:allocate` _(new — added by `PIXEL-LEGACY-001`)_

Wireframes must show a step-up auth modal _before_ the destructive action,
