...
| Risk Engine                                | D002         | DONE — PAYLOAD 10 RiskEngineService (composite scoring + Diamond Concierge intake + append-only `risk_engine_decisions` + NATS RISK*ENGINE_DECISION*\*)                                                                                                                    |
